...
// https://merkaba/chromedp/examples contains more complex examples.
package chromedp
...
import (
	...
	"merkaba/chromedp/cdproto/inspector"
	"merkaba/chromedp/cdproto/log"
...
// 注意，这个函数用了一个for循环，除非 f函数 返回 toStop=true,才会终止
