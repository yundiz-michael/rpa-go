...
//
// See the 'screenshot' example in the https://merkaba/chromedp/examples
...
func Screenshot(sel interface{}, picbuf *[]byte, opts ...QueryOption) QueryAction {
	...
	return QueryAfter(sel, nil, func(ctx context.Context, execCtx runtime.ExecutionContextID, nodes ...*cdp.Node) error {
		...
		return ElementScreenshot(ctx, picbuf, nodes[0])
	}, append(opts, NodeVisible)...)
}

/* 增加一个元素 */
func ElementScreenshot(ctx context.Context, picbuf *[]byte, node *cdp.Node) error {
	// get box model
