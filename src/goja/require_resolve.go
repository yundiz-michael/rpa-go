...
// https://nodeorg/api/modules.html#modules_all_together
func (r *RequireModule) resolve(modpath string) (module *Object, err error) {
...
func (r *RequireModule) loadNative(path string) (*Object, error) {
...
func (r *RequireModule) loadAsFileOrDirectory(path string) (module *Object, err error) {
...
func (r *RequireModule) loadAsFile(path string) (module *Object, err error) {
...
func (r *RequireModule) loadIndex(modpath string) (module *Object, err error) {
...
func (r *RequireModule) loadAsDirectory(modpath string) (module *Object, err error) {
...
func (r *RequireModule) loadNodeModule(modpath, start string) (*Object, error) {
	return r.loadAsFileOrDirectory(path.Join(start, modpath))
}

func (r *RequireModule) loadNodeModules(modpath, start string) (module *Object, err error) {
...
func (r *RequireModule) createModuleObject() *Object {
	module := r.runtime.NewObject()
	module.Set("exports", r.runtime.NewObject())
	return module
}

func (r *RequireModule) loadModule(path string) (*Object, error) {
	module := r.modules[path]
	if module == nil {
		module = r.createModuleObject()
		r.modules[path] = module
...
func (r *RequireModule) loadModuleFile(path string, jsModule *Object) error {
