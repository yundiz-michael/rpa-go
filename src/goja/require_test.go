...
func TestRequireNativeModule(t *testing.T) {
	...
	RegisterNativeModule("test/m", func(runtime *Runtime, module *Object) {
		o := module.Get("exports").(*Object)
		o.Set("test", func(call FunctionCall) Value {
...
func TestRequireRegistryNativeModule(t *testing.T) {
	...
	logWithOutput := func(w io.Writer, prefix string) ModuleLoader {
		return func(vm *Runtime, module *Object) {
			o := module.Get("exports").(*Object)
			o.Set("print", func(call FunctionCall) Value {
...
func TestResolve(t *testing.T) {
	testRequire := func(src, fpath string, globalFolders []string, fs map[string]string) (*Runtime, Value, error) {
		vm := New()
